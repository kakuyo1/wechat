/****************************************************************************
** Meta object code from reading C++ file 'taglabel.h'
**
...
#error "The header file 'taglabel.h' doesn't include <QObject>."
...
void TagLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TagLabel::*)()>(_a, &TagLabel::clicked, 0))
            return;
    }
}
