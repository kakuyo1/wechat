...
void *UserManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Singleton<UserManager>"))
        return static_cast< Singleton<UserManager>*>(this);
    if (!strcmp(_clname, "std::enable_shared_from_this<UserManager>"))
        return static_cast< std::enable_shared_from_this<UserManager>*>(this);
