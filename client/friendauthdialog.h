#ifndef FRIENDAUTHDIALOG_H
#define FRIENDAUTHDIALOG_H
...
class FriendAuthDialog : public QDialog
{
    Q_OBJECT

public:
    explicit FriendAuthDialog(QWidget *parent = nullptr);
    ~FriendAuthDialog();
